...
class adalm_loopback_cosine(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "adalm_loopback_cosine", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("adalm_loopback_cosine")
        ...
        self.settings = Qt.QSettings("GNU Radio", "adalm_loopback_cosine")
...
def main(top_block_cls=adalm_loopback_cosine, options=None):
