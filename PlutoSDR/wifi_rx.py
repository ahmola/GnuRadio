...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.network_udp_source_2 = network.udp_source(gr.sizeof_gr_complex, 1, 2000, 0, 1472, True, False, True)
        # Create the options list
        ...
        self.iio_pluto_source_2 = iio.fmcomms2_source_fc32(URI if URI else iio.get_pluto_uri(), [True, True], 32768)
        self.iio_pluto_source_2.set_len_tag_key('')
        ...
        self.blocks_delay_4 = blocks.delay(gr.sizeof_char*1, 0)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 16)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, sync_length)
        self.blocks_conjugate_cc_0 = blocks.conjugate_cc()
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.blocks_complex_to_interleaved_char_2 = blocks.complex_to_interleaved_char(False, 1.0)
        ...
        self.connect((self.blocks_complex_to_interleaved_char_2, 0), (self.blocks_delay_4, 0))
        ...
        self.connect((self.blocks_delay_4, 0), (self.fec_ber_bf_0, 1))
        ...
        self.connect((self.network_udp_source_2, 0), (self.blocks_complex_to_interleaved_char_2, 0))
        self.connect((self.network_udp_source_2, 0), (self.blocks_throttle_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_source_2.set_samplerate(self.samp_rate)
    ...
    def set_freq(self, freq):
        ...
        self.iio_pluto_source_2.set_frequency(self.freq)
