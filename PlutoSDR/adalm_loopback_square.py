...
class adalm_loopback_square(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "adalm_loopback_square", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("adalm_loopback_square")
        ...
        self.settings = Qt.QSettings("GNU Radio", "adalm_loopback_square")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 10000, 1, 0, 0)
...
def main(top_block_cls=adalm_loopback_square, options=None):
