...
class zmq_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "zmq_receive")
        ...
        # Blocks
        ##################################################
        self.zeromq_sub_msg_source_0 = zeromq.sub_msg_source(zmq_address, 100, False)
        ...
        self.connect((self.blocks_interleaved_char_to_complex_0, 0), (self.blocks_throttle_1, 0))
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.blocks_interleaved_char_to_complex_0, 0))
...
def main(top_block_cls=zmq_receive, options=None):
